...
export default function ScheduleTimeCard({ from, to, index }: Props) {
  ...
  return (
    <div className="rounded-xl border border-border-default bg-bg-secondary p-4 shadow-sm transition-colors duration-200 hover:bg-bg-secondary/80">
      <div className="mb-3 flex items-center justify-between gap-3">
        <p className="text-xs font-medium uppercase tracking-[0.24em] text-text-muted">
          Time Card {String(index).padStart(2, "0")}
        </p>
