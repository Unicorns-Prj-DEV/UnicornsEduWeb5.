...
- **Nhân sự (staff):** form gồm CCCD, ngày/nơi cấp, ngày sinh, học vấn, chuyên ngành, tài khoản/QR ngân hàng, **minh chứng thành tích** (`personal_achievement_link`, URL http(s) tùy chọn, đồng bộ với `PATCH /users/me/staff` và popup self-edit `/staff/profile`), upload ảnh CCCD.
