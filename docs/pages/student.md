...
- **API (real):**
  ...
  - `GET /users/me/student-wallet-sepay-static-qr` (SePay QR tĩnh, nội dung `[SEPAY_TRANSFER_NOTE_PREFIX] NAPVI UNIST-{uuid} UNICL-{uuid}... LOP <tên lớp...>`, không chứa số tiền; response trả thêm `classIds`)
