...
- FE session form (`AddSessionPopup`, `SessionHistoryTable`): **Điểm danh học sinh** — từ `md+` bảng **Học sinh** (tên + quick-pick dưới tên) | **Nhận xét** | **Học phí buổi** (admin/trợ lí); gia sư chỉ 2 cột; mobile card stack cùng thứ tự.
