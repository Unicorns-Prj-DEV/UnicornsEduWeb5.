...
- FE: popup tạo QR cho số tiền dương từ `1.000` VND; không fallback nạp thẳng khi SePay lỗi/chưa cấu hình. Admin có tab **Nạp thẳng** riêng và phải nhập lý do; staff/student không được chỉnh thẳng số dư.
