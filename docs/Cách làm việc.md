...
- FE: popup nạp ví hiển thị QR SePay tĩnh riêng học sinh, không nhập số tiền trong tab SePay. Admin vẫn có tab **Nạp thẳng** riêng và phải nhập lý do; staff/student không được chỉnh thẳng số dư.
